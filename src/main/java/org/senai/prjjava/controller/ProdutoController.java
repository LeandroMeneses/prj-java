...
public class ProdutoController {
    ...
    @PostMapping ("/")
    public @ResponseBody Integer addProduct (@RequestBody Produto objectProduct) {
    ...
    @GetMapping ("/{id}")
    public @ResponseBody Optional <Produto> getProduto (@PathVariable Integer id) {
        return pRepository.findById(id);
    }

    @PutMapping ("/")
    public @ResponseBody Produto atualizar(@RequestBody Produto objectProduct) {
        pRepository.save(objectProduct);
